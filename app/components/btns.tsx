...
export function BtnPrimary({ text, link, hideNav }: BtnProps) {
  return (
    <Link
      href={link}
      className="rounded-full flex flex-nowrap text-white bg-blue-800 px-4 py-2 hover:bg-opacity-60 hover:transition-all hover:duration-700 hover:ease-in-out"
      onClick={hideNav}
    >
