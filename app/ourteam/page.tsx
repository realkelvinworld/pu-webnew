          ...
          <div>
            <div className="flex flex-row justify-around flex-wrap">
              <div className="w-96">
                ...
                <p className="pb-4 text-lg text-center font-medium">
                  {" "}
              ...
              <div>
                <ul className=" font-medium lg:text-xl w-auto lg:w-[50rem]">
                  ...
                  <li>
                    ...
                    Specialized in energy physics with a BSc. in physics from
                    the School of Physical Science, University of Cape Coast,
                    Ghana. Holds an MSc. in electronic science and technology,
                    majoring in circuits and systems from the School of
                    Information Engineering, Wuhan University of Technology,
                    China. Research interests include the application of
                    artificial intelligence at the edge, digital twin technology
                    in industry automation, digital communication, and wireless
                    technology.
                  </li>
                  <br />
                  <span className="font-semibold px-2 bg-yellow-500 border-l-4 border-blue-800">
                  ...
                  <li>
                    Published eight engineering and scientific research papers
                    in both local and international journals. Authored the book
                    "Optimization of Ultrasonic Flow Meter for Crude Oil
                    Metering" published by LAMBERT Academic Publishing in
                    Germany.
                  </li>
                  <br />
                  <span className="font-semibold px-2 bg-yellow-500 border-l-4 border-blue-800">
                  ...
                  <li>
                    ...
                    Research Ghana. Served as a lecturer at All Nations
          ...
          <div>
            <div className="flex flex-row justify-around flex-wrap-reverse">
              <div>
                <ul className=" font-medium lg:text-xl w-auto lg:w-[50rem]">
                  ...
                  <li>
                    ...
                    forensics, information security, artificial intelligence,
                    and expert systems.
                  </li>
                  <br />
                  <span className="font-semibold  px-2 bg-yellow-500 border-l-4 border-blue-800">
                  ...
                  <li>
                    Student mentor in the area of Information Technology (I.T)
                    at Pentecost University from 2014 to the present.
                  </li>
                  <br />
                  <span className="font-semibold  px-2 bg-yellow-500 border-l-4 border-blue-800">
                    Areas of Interest
              ...
              <div className="w-96">
                ...
                <p className="pb-4 text-lg font-medium text-center">
                  {" "}
                  ...
                  3, Pages 874-885 by the International Telecommunication Union
                  in 2022.
                </p>
              </div>
            </div>
          ...
          <div>
            <div className="flex flex-row justify-around flex-wrap">
              <div className="w-96">
                ...
                <p className="pb-4 text-lg font-medium text-center">
                  {" "}
                  Co-author of publications on advanced communication
                  technologies and green human resource management. Co-author of
                  practical books on cost engineering and engineering practices.
                </p>
              </div>
              <div>
                <ul className=" font-medium lg:text-xl w-auto lg:w-[50rem]">
                  ...
                  <li>
                    Solid educational background with a Bachelor of Science
                    degree in Quantity Surveying and Construction Economics.
                    Additional certifications in AI technologies, computer-aided
                    design, programming, and animation.
                  </li>
                  <br />
                  <span className="font-semibold px-2 bg-yellow-500 border-l-4 border-blue-800">
                    Collaboration
                  ...
                  <li>
                    Multidisciplinary approach and collaborative efforts to
                    drive innovation in cost engineering, sustainable
                    engineering, and AI and computing. Valuable asset to the
                  ...
                  <li>
                    Researcher at the International Digital Centre affiliated
                    with Pentecost University.
                  </li>
                </ul>
              </div>
            </div>
